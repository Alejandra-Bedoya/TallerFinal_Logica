//18. Genere una lista de notas que almacene al menos 3 notas y devuelva el promedio de estas. Las notas se deben recibir por sistema y la aplicación debe pedir mediante un ciclo while o do while el total de las notas saliendo de este cuando estén almacenadas. Debe tomar de otra lista la clave (nota 1, nota 2… Promedio).
